...
function App() {
  ...
  function viewDetail(_name) {
    let _tempProduct = {};
    console.log(_name);
    let _index = products.findIndex((item) => {
      // console.log(item);
      return item.title === _name;
    });
    console.log(products[_index]);
    setTempProduct(products[_index]);
  }
  return (
